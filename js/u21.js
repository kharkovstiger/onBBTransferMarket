app.controller('u21Ctrl', ['$scope', '$http', 'credentials', function($scope, $http, credentials) {
    ...
    $scope.objectIds=[
        ...
        {
            season:40,
            officials:[43578, 43584, 43587, 43591, 43594, 43598, 43601, 44328, 44331, 44334, 44337, 44340],
            scrimmages:[43840, 44613]
        }
    ];
    $scope.gameIds=[];
    ...
    $scope.seasonStats=function (season) {
        var games=[];
        for(var j=0;j<$scope.objectIds[season-6].officials.length;j++) {
            games.push($scope.objectIds[season-6].officials[j]);
        }
        if (!$scope.official){
            for(var j=0;j<$scope.objectIds[season-6].scrimmages.length;j++) {
                games.push($scope.objectIds[season-6].officials[j]);
            }
        }
        $scope.stats(games);
