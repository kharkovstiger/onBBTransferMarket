app.controller('opponentsNTCtrl', ['$scope', '$http', 'credentials', function($scope, $http, credentials) {
    ...
    $scope.get=function () {
        ...
        allCountries.forEach(function (country) {
            if (country!=$scope.country && country!='Utopia' && country!='Nations of Africa'){
                $http.post(myBaseURL+'/game/resultsForCountryAgainstCountry', [$scope.country, country]).then(
                    function (response) {
